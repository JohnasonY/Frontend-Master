1. Write a regular expression to match a string, returning the number of matches and the matched results.

2. Get the number of Chinese characters in a string.

3. Filter sensitive words: given an array of sensitive words, replace each occurrence in the string with four asterisks (****).

["Communist Party", "too young too simple", "Marketing"]

4. Get the number of chapters that appear in an HTML string.
